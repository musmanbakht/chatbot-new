...
AS $$
DECLARE
  project_url TEXT := 'https://sqdvxbtccvjtsookszfa.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNxZHZ4YnRjY3ZqdHNvb2tzemZhIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwOTU3NjI1NywiZXhwIjoyMDI1MTUyMjU3fQ.CWJi5DGEo8XlzNHS92oz-_LHJFQNgrTtSUxCdrIB0w0'; -- full access needed for http request to storage
